Pod::Spec.new do |s|
  ...
  s.homepage     = 'https://github.com/YSavitskiy/ZstdKit'
  s.authors      = { 'Paw' => 'https://paw.cloud' }
  s.source       = { :git => 'https://github.com/YSavitskiy/ZstdKit', :tag => s.version, :submodules => true }
  ...
  s.preserve_paths = 'ZstdKit/**/*', 'Dependencies/**/*'
